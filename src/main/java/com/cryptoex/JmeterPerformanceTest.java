...
public class JmeterPerformanceTest extends AbstractJavaSamplerClient{
    ...
    public void setupTest(JavaSamplerContext jsc) {
        client = new Client("AAAADBVJduGildYLPQ4NN3JU", "OZ6IprAoja0PusNM");
    ...
    public SampleResult runTest(JavaSamplerContext arg0) {
        ...
        try {
            ...
            if(inNumInt %2 == 0) {
                orders = client.request(Map.class, null, "POST", "/v1/trade/orders", null, new BusinessOrder("0.001", "BUY_LIMIT", "1.2", "BTC_USDT"), null);
            } else {
                orders = client.request(Map.class, null, "POST", "/v1/trade/orders", null, new BusinessOrder("0.001", "SELL_LIMIT", "1.2", "BTC_USDT"), null);
            }
